...
public class PlayerPredicate : IPredicate<PlayerControllerB>
{
    ...
    [JsonProperty("held_item")] public ItemPredicate? HeldItemPredicate;
    ...
    /// </summary>
    /// <seealso cref="ItemPredicate" />
    [JsonProperty("inventory")] public ItemPredicate[]? InventoryPredicates;
    ...
    /// <summary>
    ///     Checks if the player matches all the specified conditions.
    /// </summary>
    public bool Check(PlayerControllerB player)
    {
        if (HeldItemPredicate is not null)
        {
            ...
            if (item == null || !HeldItemPredicate.Check(item)) return false;
        }
